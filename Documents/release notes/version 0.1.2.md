...
- [Tags now are persistent](https://github.com/CMDT/TimeSeriesDataCapture/issues/5). When an new tag is added,  deleted or edited changes are sent to the browse api and stored in the database
